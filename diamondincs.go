...
func main() {
	...
	fmt.Println("")
	//PrintArt("diamond")
	fmt.Println("Welcome to Diamonds Inc. I know it is your first day so let me show you around. \nI'm Leroy Shaw the owner of this fine jewelry establishment.")
